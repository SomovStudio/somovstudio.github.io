document.addEventListener('DOMContentLoaded', function() {
    ...
    changeDownloadUrl(btnHatDownload1, 'https://github.com/SomovStudio/Hat/releases/download/v1.5.5/Hat-1.5.5.zip');
    changeDownloadUrl(btnHatDownload2, 'https://github.com/SomovStudio/Hat/releases/download/v1.5.5/Hat-1.5.5.zip');
    ...
    updateHatVersion('v1.5.5', '07/09/2026');
